...
function theme.build_font(args)
    ...
    local font = args.name or theme.font_name -- or theme.taglist_font
...
theme.palette = setmetatable({
    ...
    orange = "#de935f",
    yellow = "#f0c674",
    green = "#b5a642", -- "#7cb36b", -- original: #b5bd68
    ...
    green_bright = "#ddd1a0", -- "#71c464", -- original: #b9ca4a
...
theme.wibar = {
    bg = theme.common.bg,
    -- bg = theme.palette.green_20,
    spacing = dpi(4),
    paddings = hui.new({ dpi(4), dpi(2) }),
}

theme.wibar.item_height = dpi(25)
...
theme.popup.default_style = {
    ...
    fg = theme.common.fg,
    -- border_color = theme.common.bg_bright,
    border_color = theme.common.bg_75,
    border_width = dpi(3),
    shape = function(cr, width, height)
...
theme.taglist.item = {
    normal = setmetatable({
        border_width = dpi(1),
        bg = theme.palette.magenta_57,
    }, { __index = theme.capsule.styles.normal }),
    active = setmetatable({
        bg = theme.common.primary_bright,
        fg = theme.common.fg_30,
...
theme.client = {
    normal = {
        ...
        border_color = theme.common.primary_30,
